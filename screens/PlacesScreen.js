...
//     },[])
    ...
    // in order to access the Place and PlaceContext thing inside PlacesScreen we are using const hook state  
  ...
  return (
    <View>
      ...
      <FlatList numColumns={2} columnWrapperStyle={{justifyContent:'space-between'}} data={places} renderItem={({item,index})=>(
        <Pressable onPress={()=>selectCity(item.place)} style={{marginVertical:0,marginHorizontal:20}}>
