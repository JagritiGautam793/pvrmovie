...
const HomeScreen = () => { 
  ...
  //   npm add react-native-modals --in order to filer out on the basis of language here
      ...
      >
        <ModalContent style={{ width: "100%", height: 320 }}>
          ...
          >
            ...
            // if i press then setselectedFilter will again gonna be empty 
