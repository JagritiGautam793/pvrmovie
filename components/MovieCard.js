...
const MovieCard = ({item}) => {
  ...
  return (
    <SafeAreaView> 
     ...
     <Pressable style={{flex:1,borderRadius:5,marginHorizontal:17,marginVertical:10,justifyContent:"center",height:Dimensions.get("window").height/2.5,
     width:(Dimensions.get("window").width-80)/2
      ...
      <Image source={{
        ...
        style={{width:"100%",height:"60%",resizeMode:"contain",borderRadius:7}}
        />
        <View>
